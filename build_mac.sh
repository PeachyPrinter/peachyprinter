...
/opt/git/create-dmg/create-dmg --volname $dmg_name --background $background_image --window-size $backgound_width $background_height --icon-ize $icon_size --icon $app $app_pos_x $app_pos_y --app-drop-link $sym_pos_x $sym_pos_y --hide-extension $app
